...
// nolint: cyclop
func (l *Logger) lowercase(s Severity) string {
	switch s {
	case DEFAULT:
	...
	default:
		if l != nil && l.customSeverities != nil && l.customSeverities[s] != nil {
			return l.customSeverities[s].lowercase
		}
...
// nolint: cyclop
func (l *Logger) uppercase(s Severity) string {
	switch s {
	case DEFAULT:
	...
	default:
		if l != nil && l.customSeverities != nil && l.customSeverities[s] != nil {
			return l.customSeverities[s].uppercase
		}
